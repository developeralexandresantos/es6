...
console.log(idade);
var trabalhaEMaiorQue18 = usuario.filter(function (item) {
  return item.idade > 18 && item.empresa === "DreamMaker";
});
console.log(trabalhaEMaiorQue18);
var encontraGoogle = usuario.find(function (item) {
  return item === "Google";
});
console.log(encontraGoogle);
var multiplicador = usuario.map(function (item) {
  var multiplicacao = _objectSpread({}, item, {
    idade: item.idade * 2
  });
...
console.log(idadeMultiplicada); // Desafio 3.1
...
mostraIdade(usuario1); // Desafio 3.3
